...
namespace Project8
{
    ...
    public class Fleet
    {
        ...
        /// <exception cref="Project8.ShipCollisionException"></exception>
        ...
        /// <summary>
        /// Finds the BattleShip in the fleet and returns its Length.
        /// </summary>
        /// <returns>Length of the BattleShip.</returns>
